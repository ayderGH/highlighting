...
if __name__ == "__main__":
    ...
    # # matches_2 = hp.find_text(mismatch_data_money_searching_text_1, new_filing_text, ignore_dates=True, ignore_moneys=True)
    # # matches_3 = hp.find_text(mismatch_data_money_searching_text_2, new_filing_text, ignore_dates=True, ignore_moneys=True)
    #
    # print("Mathces_1: {}".format(matches_1))
    # # print("Mathces_2: {}".format(matches_2[0][0]))
    # # print("Mathces_3: {}".format(matches_3[0][0]))
